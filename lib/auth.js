...
// if function the passes an error message if the user name and password combo doesn't exist
// Collaborated with Krystyna and Joey to complete this function
// looks for combo and if not in data base, sends error message;
    if (!dbUser) {
      res.render('index', {
        error: 'Username and password combonation don\'t exist',
      });
    }
